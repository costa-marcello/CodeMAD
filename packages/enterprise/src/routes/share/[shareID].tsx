...
import { DataProvider } from "@codemad/ui/context"
import { DiffComponentProvider } from "@codemad/ui/context/diff"
import { CodeComponentProvider } from "@codemad/ui/context/code"
import { WorkerPoolProvider } from "@codemad/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@codemad/ui/logo"
import { IconButton } from "@codemad/ui/icon-button"
import { ProviderIcon } from "@codemad/ui/provider-icon"
import { createDefaultOptions } from "@codemad/ui/pierre"
import { iife } from "@codemad/util/iife"
import { Binary } from "@codemad/util/binary"
import { NamedError } from "@codemad/util/error"
...
import { Diff as SSRDiff } from "@codemad/ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "@codemad/ui/icons/provider"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("@codemad/ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("@codemad/ui/code").then((m) => ({ default: m.Code })))
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@codemad/ui/pierre/worker").then((m) => ({
