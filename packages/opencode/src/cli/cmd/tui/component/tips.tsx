...
const TIPS = [
  ...
  "CodeMAD auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "CodeMAD auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "CodeMAD uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent CodeMAD from reading sensitive files",
  "Use {highlight}codemad run{/highlight} for non-interactive scripting",
  "Use {highlight}codemad --continue{/highlight} to resume the last session",
  "Use {highlight}codemad run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}codemad serve{/highlight} for headless API access to CodeMAD",
  "Use {highlight}codemad run --attach{/highlight} to connect to a running server",
  "Run {highlight}codemad upgrade{/highlight} to update to the latest version",
  "Run {highlight}codemad auth list{/highlight} to see all configured providers",
  "Run {highlight}codemad agent create{/highlight} for guided agent creation",
  "Use {highlight}/codemad{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}codemad github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/codemad fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}codemad debug config{/highlight} to troubleshoot configuration",
