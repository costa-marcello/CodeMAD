...
import { createOpencodeClient, type OpencodeClient } from "@codemad/sdk/v2"
...
export const RunCommand = cmd({
  command: "run [message..]",
  describe: "run codemad with a message",
  builder: (yargs: Argv) => {
    return yargs
      .positional("message", {
      ...
      .option("attach", {
        type: "string",
        describe: "attach to a running codemad server (e.g., http://localhost:4096)",
      })
      .option("port", {
        type: "number",
