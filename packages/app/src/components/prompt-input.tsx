import { useFilteredList } from "@codemad/ui/hooks"
import {
  createEffect,
  on,
  Component,
...
import { Select } from "@codemad/ui/select"
import { getDirectory, getFilename, getFilenameTruncated } from "@codemad/util/path"
import { useDialog } from "@codemad/ui/context/dialog"
import { ImagePreview } from "@codemad/ui/image-preview"
...
import { createOpencodeClient, type Message, type Part } from "@codemad/sdk/v2/client"
