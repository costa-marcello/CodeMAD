export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by CodeMAD",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CodeMAD.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "CodeMAD Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CodeMAD.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CodeMAD.",
  ...
  "dialog.server.description": "Switch which CodeMAD server this app connects to.",
  ...
  "toast.update.description": "A new version of CodeMAD ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the CodeMAD team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CodeMAD does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CodeMAD includes free models so you can start immediately.",
  "sidebar.gettingStarted.line2": "Connect any provider to use models, inc. Claude, GPT, Gemini etc.",
  "sidebar.project.recentSessions": "Recent sessions",
  "sidebar.project.viewAllSessions": "View all sessions",

  "app.name.desktop": "CodeMAD Desktop",
  ...
  "settings.general.row.language.description": "Change the display language for CodeMAD",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how CodeMAD looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CodeMAD is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CodeMAD launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CodeMAD.",
